...
@RunWith(Suite.class)
@Suite.SuiteClasses({DashboardLogicUnitTest.class, TodoLogicLayerUnitTests.class, FakeDBUnitTests.class, DBUnitTests.class, TimeEstimatorUnitTests.class, DashboardLogicAndDBTests.class, TodoLogicAndDBTests.class, CalendarLogicTest.class, TodoLogicAndTimeEstimatorTests.class, CalendarAndDBTests.class})
