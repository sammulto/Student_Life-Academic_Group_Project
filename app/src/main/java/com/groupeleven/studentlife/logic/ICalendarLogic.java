...
public interface ICalendarLogic {
    ...
    public void editTask(int id, String name, String priorityText, String endTime); //Tap on edit to editTask (time/date/description)

    public void deleteTask(int id); //delete a task in the calendar
